...
func TestValidateSecretID(t *testing.T) {
	cases := []struct {
		...
		{"hyphen segment", "ssh.main-private-key", false},
		{"aws profile with hyphen", "aws.profile.amzn-wanfe", false},
		{"leading hyphen segment", "aws.profile.-foo", true},
		{"uppercase segment", "aws.profile.Foo", true},
		{"trailing hyphen segment", "aws.profile.foo-", false},
